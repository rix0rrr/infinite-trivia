...
var author$project$OpenTDB$Question = F6(
	function (category, questionType, difficulty, question, correctAnswer, incorrectAnswers) {
		return {category: category, correctAnswer: correctAnswer, difficulty: difficulty, incorrectAnswers: incorrectAnswers, question: question, questionType: questionType};
	});
var author$project$OpenTDB$Easy = {$: 'Easy'};
var author$project$OpenTDB$Hard = {$: 'Hard'};
var author$project$OpenTDB$Medium = {$: 'Medium'};
var author$project$OpenTDB$UnknownDifficulty = {$: 'UnknownDifficulty'};
...
var author$project$OpenTDB$difficultyDecoder = function () {
	var toDifficulty = function (input) {
		switch (input) {
			case 'easy':
				return author$project$OpenTDB$Easy;
			case 'medium':
				return author$project$OpenTDB$Medium;
			case 'hard':
				return author$project$OpenTDB$Hard;
			default:
				return author$project$OpenTDB$UnknownDifficulty;
		}
	};
	return A2(elm$json$Json$Decode$map, toDifficulty, elm$json$Json$Decode$string);
}();
var author$project$OpenTDB$Boolean = {$: 'Boolean'};
var author$project$OpenTDB$MultipleChoice = {$: 'MultipleChoice'};
var author$project$OpenTDB$UnknownType = {$: 'UnknownType'};
var author$project$OpenTDB$typeDecoder = function () {
	var toType = function (input) {
		switch (input) {
			case 'multiple':
				return author$project$OpenTDB$MultipleChoice;
			case 'boolean':
				return author$project$OpenTDB$Boolean;
			default:
				return author$project$OpenTDB$UnknownType;
		}
	};
...
var author$project$Main$Answering = {$: 'Answering'};
...
var author$project$Main$skip = function (_n0) {
	...
	var currentQuestion = _n0.currentQuestion;
	var futureQuestions = _n0.futureQuestions;
		...
		return elm$core$Maybe$Just(
			{
				...
				futureQuestions: nextFutureQuestions,
				seenQuestions: A2(elm$core$List$cons, currentQuestion, seenQuestions)
			});
	} else {
		return elm$core$Maybe$Nothing;
	}
		...
		if (_n0.$ === 'Just') {
			...
			var nextCommand = A2(
				...
				A2(
					...
					function (ng) {
						return (elm$core$List$length(ng.futureQuestions) <= 2) ? elm$core$Maybe$Just(
			...
			if (message.$ === 'GotQuestionBatch') {
				...
				if (result.$ === 'Ok') {
					var response = result.a;
					return _Utils_Tuple2(
						author$project$Main$createModel(
							author$project$Main$questionsFromResponse(response)),
						elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
...
var author$project$Main$styleAsCard = F2(
	function (face, contents) {
		...
		var backgroundStyle = function () {
			if (face.$ === 'Back') {
				return rtfeldman$elm_css$Css$backgroundImage(
					rtfeldman$elm_css$Css$url('/static/kale-salad.jpg'));
			} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Html$Styled$div,
						_List_Nil,
						author$project$Main$literalHtml(question.category)),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_Nil,
						author$project$Main$literalHtml(question.question)),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_Nil,
						author$project$Main$literalHtml(question.answer))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$class('controls')
					]),
				_List_fromArray(
					[
						A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$Skip)
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('skip')
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$button,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$Answer)
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('answer')
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$Ask)
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('ask')
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$url('/static/interlaced.png')),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Message","aliases":{"OpenTDB.Question":{"args":[],"type":"{ category : String.String, questionType : OpenTDB.Type, difficulty : OpenTDB.Difficulty, question : String.String, correctAnswer : String.String, incorrectAnswers : List.List String.String }"},"OpenTDB.Response":{"args":[],"type":"{ questions : List.List OpenTDB.Question }"}},"unions":{"Main.Message":{"args":[],"tags":{"Skip":[],"Ask":[],"Answer":[],"Next":[],"GotQuestionBatch":["Result.Result Http.Error OpenTDB.Response"]}},"OpenTDB.Difficulty":{"args":[],"tags":{"Easy":[],"Medium":[],"Hard":[],"UnknownDifficulty":[]}},"OpenTDB.Type":{"args":[],"tags":{"MultipleChoice":[],"Boolean":[],"UnknownType":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));